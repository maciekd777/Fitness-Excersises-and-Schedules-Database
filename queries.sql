...
SELECT 
	...
	"mp_level" AS "muscle_participation_level", 
	ROUND(AVG("score"), 2) AS "average_score", 
	ROUND(AVG("difficulty_level"), 2) AS "average_difficulty_level", 
	ROUND(AVG("weight_level"), 2) AS "average_weight_level"  
FROM "excersises"
...
ORDER BY "muscle_participation_level" DESC, 
	"average_score" DESC, 
	"average_difficulty_level" DESC, 
	"average_weight_level" DESC;
...
SELECT 
	"users"."username",  
	"score", "review", 
	"advices", "difficulty_level", 
	"weight_level" 
FROM "excersises_reviews"
...
INSERT INTO "muscle_connections"(
	"excersise_id", 
	"muscle_id", 
	"mp_level"
)
...
INSERT INTO "excersises_reviews"(
	"user_id", 
	"excersise_id", 
	"score", 
	"difficulty_level", 
...
INSERT INTO "schedules_excersises" (
	"schedule_id", 
	"day_id", 
	"excersise_id", 
	"weight_level", 
...
INSERT INTO "schedules_responses" (
	"schedule_review_id", 
	"user_id", 
	"comment"
)
